...
spark = SparkSession.builder \
    .appName("ITJobs_Location_Count") \
    .master("local[*]") \
    .getOrCreate()

# === Đường dẫn input/output ===
input_path = Path('/home/hadoopducdung/Output/cleaned_data.parquet')
tmp_output_dir = Path('/opt/Output_sparkQL/tmp_job_count_by_location')
final_output = Path('/opt/Output_sparkQL/job_count_by_location.csv')
...
print("📊 Top Locations by Job Count:")
